...
export interface ApiJobJob extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    applicationInstructions: Schema.Attribute.RichText &
      Schema.Attribute.Required;
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::job.job'> &
      Schema.Attribute.Private;
    openingDate: Schema.Attribute.Date & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiUafPageUafPage extends Struct.SingleTypeSchema {
  ...
  info: {
    displayName: 'UAF Page';
    pluralName: 'uaf-pages';
    singularName: 'uaf-page';
  };
  options: {
    draftAndPublish: true;
  };
